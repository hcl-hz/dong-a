...
(function () {
  ...
  function initDNews() {
    ...
    if (!sec) return;
    var NEWS = [
      { title: "동아-동서 글로컬 연합대학, 연합전공 학생팀 2년 연속 우수 성과", desc: "동아대학교(총장 이해우)는 ‘동아-동서 글로컬 연합대학’ 연합전공 참여 학생들이 특허 출원과 장관상 수상 등 2년 연속 가시적인 성과를 거두며 부산형 개방형 연합대학의 대표 교육혁신 모델로 자리매김하고 있다고 23일 밝혔다. 전력반도체 연합전공을 이수 중인 현예은(전자공학과 3)·김민지(전기공학과 3)·박지윤(AI학과 2) 학생으로 구성된 ‘코일(COIL)’ 팀은 한국폴리텍대학 영남융합기술캠퍼스에서 지난 4일부터 이틀 동안 열린 ‘2026 국제물류로봇경진대회(ILRC)’에서 1위에 올라 고용노동부 장관상을 차지했다. 이번 대회엔 국내외 129개 팀, 361명이 참가했다.", date: "2026.06.23", img: "uploads/2d093a956af8485d905a7a0bffcdf230.jpeg" },
